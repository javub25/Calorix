        ...
        <footer>
            <nav>
                <section>
                    <ul>
                        <li>
                            <img src={profile} alt="GitHub Profile" className="rounded-full w-18 h-18 mx-auto
                            mb-4 border-4 border-white"/>
                        </li>
                        <li className="grid grid-flow-col gap-4 place-content-center">
                            <a href="https://github.com/javub25/Calorix" target="_blank" title="Github"
                                className="bg-[#374151] p-2 rounded-full transition-transform hover:-translate-y-1 hover:shadow-lg">
                            ...
                            <a href="https://www.linkedin.com/in/javierubedarayo/" target="_blank" title="Linkedin"
                                className="bg-[#2563EB] p-2 rounded-full transition-transform hover:-translate-y-1 hover:shadow-lg">
                                    <svg width="27" height="27" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier"> 
                            ...
                            <a href="mailto:javierubeda832@gmail.com" target="_blank" title="Mail"
                                className="bg-[#F87171] p-2 rounded-full transition-transform hover:-translate-y-1 hover:shadow-lg">
                                    ...
                                    <path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h8"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/><path d="M19 16v6"/><path d="M16 19h6"/></svg>
                            </a>
                        </li>
                        <li>
                            <p className="text-white mt-4">© 2025 - Javier Úbeda Rayo</p>
                        </li>
                    </ul>
                </section>
            </nav>
